...
public class InfiniteProgressPanel extends JComponent implements MouseListener
{
    ...
    public void start()
    {
        ...
        cx = getTopLevelAncestor().getWidth() / 2;
        cy = getTopLevelAncestor().getHeight() / 2;
        ticker = buildTicker();
    ...
    public void paintComponent(Graphics g)
    {
        if (started)
        {
            ...
            for (int i = 0; i < ticker.length; i++)
            {
                ...
                // TODO: FUgly fix here, try to get rid of this... 
                try{
    ...
    private Area[] buildTicker()
    {
        ...
        Point2D.Double center = new Point2D.Double((double) cx, (double) cy);
